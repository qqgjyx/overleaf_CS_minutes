...
\begin{itemize}
    ...
    \item \juntang[inline]{TBP: bad WHU-Hi}
    \item \juntang[inline]{TBP: BEN improved}
\end{itemize}

\subsection*{TODO}
\begin{itemize}
    \item \juntang[inline]{\checkmark \ BENloader: {\tiny \href{https://gitlab.oit.duke.edu/jw853/clustering4hsi/-/blob/main/src/loaders/benloader.py?ref_type=heads}{\textit{src/loaders/benloader.py}}}}
    \item \dimitris[inline]{Framework of BEER in Python}
    \item \juntang[inline]{\checkmark \ Notes for the datasets}
